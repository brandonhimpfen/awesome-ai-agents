...
- [YYLO](https://github.com/yylo-dev/yylo) – Command-line orchestrator for coding agents: each task runs in a dedicated branch/worktree with typed validation and merge boundaries.
